  ...
  <div class="header__menu">
    <nav id="navbar" class="header__nav collapse">
      <ul class="header__elenco">
        ...
        <c:if test="${empty id}">
        <a href="/commons/LoginForm.jsp" class="btn btn--white" >login</a>
        </c:if>
    ...
    <div class="col-md-6 article-pre__col">
      <a href="#" class="article-pre ">
        ...
        <h2 class="article-pre__info">
          <span class="article-pre__cat">Protips â¢ </span><span class="article-pre__aut"> by Ann Timothy</span> <span class="article-pre__date"> - 5 mins read</span>
        </h2>
        <h1 class="article-pre__title">How to improve analytics using few tools in Bricks<span class="article-pre__arrow--purple"> â</span></h1>
      </a>
    </div>
      ...
      <a href="#" class="article-pre ">
        ...
        <h2 class="article-pre__info">
          <span class="article-pre__cat">Pricing â¢ </span><span class="article-pre__aut"> by Josh Ford</span> <span class="article-pre__date"> - 5 mins read</span>
        </h2>
        <h1 class="article-pre__title">Rich Thornett & Dan Coderholm about Dribbble in early 2009<span class="article-pre__arrow--purple">â</span></h1>
      </a>
    </div>    
 </div>
  <div class="row">
     <div class="col-md-6 article-pre__col">
      <a href="#" class="article-pre ">
        ...
        <h2 class="article-pre__info">
          <span class="article-pre__cat">Success Stories â¢ </span><span class="article-pre__aut"> by Andrew Lincoln</span> <span class="article-pre__date"> - 5 mins read</span>
        </h2>
        <h1 class="article-pre__title">Steward Butterfield told us about his startup Slack<span class="article-pre__arrow--purple"> â</span></h1>
      </a>
    </div>
